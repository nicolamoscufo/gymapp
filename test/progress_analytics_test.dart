...
void main() {
  test('progress analytics builds exercise, muscle, PR and period summaries', () {
    final history = [
      _session(
      ...
      _session(
        ...
        [
          ...
          _exercise('Rematore', MuscleGroup.back, [
            _set(70, 10),
            _set(70, 10),
          ]),
        ],
    ...
    final bench = analytics.exercises.firstWhere((entry) => entry.name == 'Panca');
